...
OUTPUT_DIR="${WORK_DIR}/tfrecord_v1_rnd_0"
mkdir -p "${OUTPUT_DIR}"

echo "Converting ADE20K dataset class 0..."
python ./build_ade20k_data.py  \
  --train_image_folder="${ADE20K_ROOT}/v1_rnd/img_train_0/" \
  --train_image_label_folder="${ADE20K_ROOT}/v1_rnd/anno_train_0/" \
  --val_image_folder="${ADE20K_ROOT}/v1_rnd/img_val_0/" \
  --val_image_label_folder="${ADE20K_ROOT}/v1_rnd/anno_val_0/" \
  --output_dir="${OUTPUT_DIR}"

OUTPUT_DIR="${WORK_DIR}/tfrecord_v1_rnd_1"
mkdir -p "${OUTPUT_DIR}"

echo "Converting ADE20K dataset class 1..."
python ./build_ade20k_data.py  \
  --train_image_folder="${ADE20K_ROOT}/v1_rnd/img_train_1/" \
  --train_image_label_folder="${ADE20K_ROOT}/v1_rnd/anno_train_1/" \
  --val_image_folder="${ADE20K_ROOT}/v1_rnd/img_val_1/" \
  --val_image_label_folder="${ADE20K_ROOT}/v1_rnd/anno_val_1/" \
  --output_dir="${OUTPUT_DIR}"

OUTPUT_DIR="${WORK_DIR}/tfrecord_v1_rnd_2"
mkdir -p "${OUTPUT_DIR}"

echo "Converting ADE20K dataset class 2..."
python ./build_ade20k_data.py  \
  --train_image_folder="${ADE20K_ROOT}/v1_rnd/img_train_2/" \
  --train_image_label_folder="${ADE20K_ROOT}/v1_rnd/anno_train_2/" \
  --val_image_folder="${ADE20K_ROOT}/v1_rnd/img_val_2/" \
  --val_image_label_folder="${ADE20K_ROOT}/v1_rnd/anno_val_2/" \
  --output_dir="${OUTPUT_DIR}"
